## gazebo6_ros_pkgs (jade) - 2.5.0-1

The packages in the `gazebo6_ros_pkgs` repository were released into the `jade` distro by running `/usr/bin/bloom-release --track jade --ros-distro jade gazebo6_ros_pkgs --edit` on `Wed, 12 Aug 2015 02:23:51 -0000`
...
## gazebo6_ros_pkgs (indigo) - 2.4.8-1
